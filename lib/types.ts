...
// Employee2 matches backend Employee schema
export type Employee2 = {
  ...
  account_type?: string | null;
  tax_id?: string | null;
  bank_accounts?: { bank_name?: string; account_number?: string; ifsc_code?: string; account_type?: string; tax_id?: string }[] | null;
  system_access_rights?: string | null;
...
// Employee2ListItem maps to backend Employee schema for list display
